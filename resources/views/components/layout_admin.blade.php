                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                                <img alt="image" class="img-circle" src="admin_assets/img/profile_small.jpg" />
                            </span>
                    ...
                    <x-navbar_item href="/admin" icon="fa-th-large">Dashboard</x-navbar_item>
                    <x-navbar href="/admin-profile">Admin Profile</x-navbar>
                    <li>
                        <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Management
                                System</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <x-navbar href="/admin-user">Management User</x-navbar>
                            <x-navbar href="/admin-property">Management Property</x-navbar>
                            <x-navbar href="/admin-rotator">Management Rotator</x-navbar>
                            <x-navbar href="/admin-review">Management Review</x-navbar>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message">Welcome to <i><b>Opendoorz Admin
                                        System</b></i> Theme.</span>
                        </li>
                        {{-- <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="admin_assets/img/a7.jpg">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="admin_assets/img/a4.jpg">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="admin_assets/img/profile.jpg">
                                </a>
                                <div>
